    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            ListTile(
              onTap: () => Get.to(() => const MyWebView(title: 'Privacy Policy', url: APIConstant.privacyPrivacy)),
            ...
            ListTile(
              onTap: () => Get.to(() => const MyWebView(title: 'Shipping Policy', url: APIConstant.shippingPolicy)),
            ...
            ListTile(
              onTap: () => Get.to(() => const MyWebView(title: 'Terms and Conditions', url: APIConstant.termsAndConditions)),
            ...
            ListTile(
              onTap: () => Get.to(() =>  const MyWebView(title: 'Return Policy', url: APIConstant.refundPolicy)),
